...
function bigcloudcms_widgets_init() {
  ...
  // Widgets
  register_widget('BigCloudCMS_Contact_Widget');
  register_widget('BigCloudCMS_Social_Widget');
  register_widget('BigCloudCMS_Recent_Posts_Widget');
  register_widget('BigCloudCMS_Testimonial_Slider_Widget');
  register_widget('BigCloudCMS_Image_Grid_Widget');
 ...
 * Contact widget
 */
class BigCloudCMS_Contact_Widget extends WP_Widget {
  private static $instance = 0;
    ...
    parent::__construct('widget_bigcloudcms_contact', __('BigCloudCMS: Contact/Vcard', 'bigcloudcms'), $widget_ops);
  }
 ...
 * Social widget
 */
class BigCloudCMS_Social_Widget extends WP_Widget {
  private static $instance = 0;
    public function __construct() {
    $widget_ops = array('classname' => 'widget_bigcloudcms_social', 'description' => __('Simple way to add Social Icons', 'bigcloudcms'));
    parent::__construct('widget_bigcloudcms_social', __('BigCloudCMS: Social Links', 'bigcloudcms'), $widget_ops);
  }
...
/**
 * BigCloudCMS Recent_Posts widget class
 *  Just a rewite of wp recent post
 * 
 */
class BigCloudCMS_Recent_Posts_Widget extends WP_Widget {
  ...
  private static $instance = 0;
    public function __construct() {
      ...
      parent::__construct('bigcloudcms_recent_posts', __('BigCloudCMS: Recent Posts', 'bigcloudcms'), $widget_ops);
...
/**
 * BigCloudCMS Testimonial_slider widget class
 *  Just a rewite of wp recent post
 * 
 */
class BigCloudCMS_Testimonial_Slider_Widget extends WP_Widget {
  ...
  private static $instance = 0;
    public function __construct() {
      ...
      parent::__construct('bigcloudcms_testimonials_slider', __('BigCloudCMS: Testimonial Carousel', 'bigcloudcms'), $widget_ops);
  }
...
?>
    ...
    <input class="widefat" id="<?php echo $this->get_field_id('speed'); ?>" name="<?php echo $this->get_field_name('speed'); ?>" type="text" value="<?php echo esc_attr($speed); ?>" />
     ...
     <p>
    <label for="<?php echo $this->get_field_id('autoplay'); ?>"><?php _e('Autoplay:', 'bigcloudcms'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('conditional_readmore_link'); ?>"><?php _e('Conditional read more link if more content:', 'bigcloudcms'); ?></label>
...
/**
 * BigCloudCMS_Image_Grid_Widget widget class
 * 
 */
class BigCloudCMS_Image_Grid_Widget extends WP_Widget {
  ...
  private static $instance = 0;
    public function __construct() {
      ...
      parent::__construct('bigcloudcms_image_grid', __('BigCloudCMS: Post Grid', 'bigcloudcms'), $widget_ops);
  }
...
class Simple_About_With_Image extends WP_Widget{
    ...
    public function __construct() {
        ...
        parent::__construct('bigcloudcms_about_with_image', __('BigCloudCMS: Image', 'bigcloudcms'), $widget_ops);
    }
