    ...
    class ReduxFramework_kad_slides {
        ...
        public function render() {
             ...
             $defaults = array(
                ...
                'content_title' => __ ( 'Slide', 'bigcloudcms' )
            );
           ...
           echo '<div class="redux-slides-accordion" data-new-content-title="' . esc_attr ( sprintf ( __ ( 'New %s', 'bigcloudcms' ), $this->field[ 'content_title' ] ) ) . '">';
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                   ...
                   if ( empty ( $slide[ 'thumb' ] ) && !empty ( $slide[ 'attachment_id' ] ) ) {
                    ...
                    echo '<span class="button media_upload_button" id="add_' . $x . '">' . __ ( 'Upload', 'bigcloudcms' ) . '</span>';
                    ...
                    echo '<li><input type="text" id="' . $this->field['id'] . '-url_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][url]" value="' . esc_attr($slide['url']) . '" class="full-text upload" placeholder="'.__('URL', 'bigcloudcms').'" /></li>';
                    ...
                    echo '<li><input type="text" id="' . $this->field['id'] . '-link_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][link]" value="' . esc_attr($slide['link']) . '" placeholder="'.__('Slide Link', 'bigcloudcms').'" class="full-text" /></li>';
                    ...
                    echo '<li><a href="javascript:void(0);" class="button deletion redux-slides-remove">' . __('Delete Slide', 'bigcloudcms') . '</a></li>';
            ...
            if ($x == 0) {
                ...
                $placeholder = (isset($this->field['placeholder']['link'])) ? esc_attr($this->field['placeholder']['link']) : __( 'Slide Link', 'bigcloudcms' );
            ...
            echo '</div><a href="javascript:void(0);" class="button redux-slides-add2 kad_redux-slides-add button-primary" rel-id="' . $this->field[ 'id' ] . '-ul" rel-name="' . $this->field[ 'name' ] . '[title][]">' . sprintf ( __ ( 'Add %s', 'bigcloudcms' ), $this->field[ 'content_title' ] ) . '</a><br/>';
        }
