<?php
 ...
 if (have_comments()) : ?>
  <section id="comments">
    ...
    <ol class="media-list">
      <?php wp_list_comments(array('walker' => new BigCloudCMS_Walker_Comment)); ?>
    </ol>
    ...
    <?php $comment_args = array( 'fields' => apply_filters( 'comment_form_default_fields', array(
           'author' => '<div class="col-md-4">' . '<label for="author">' . __('Name', 'bigcloudcms') . ( $req ? ' <span class="comment-required">*</span>' : '' ) . '</label> ' .
            ...
            'url'    => '<div class="col-md-4"><label for="url">' . __( 'Website', 'bigcloudcms' ) . '</label> ' .
              ...
              'comment_field'        => '<p class="comment-form-comment"><label for="comment">' . __( 'Comment', 'bigcloudcms' ) . '</label> <textarea id="comment" name="comment" cols="45" rows="8" class="input-xlarge" aria-required="true" required="required"></textarea></p>',
              ...
              'name_submit'          => 'submit',
              'title_reply'          => __('Leave a Reply', 'bigcloudcms'),
              'title_reply_to'       => __('Leave a Reply to %s', 'bigcloudcms'),
              'label_submit'         => __('Submit Comment', 'bigcloudcms'),
