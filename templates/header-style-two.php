...
<?php global $bigcloudcms_premium; 
      if(isset($bigcloudcms_premium['logo_layout'])) {
        if($bigcloudcms_premium['logo_layout'] == 'logocenter') {
            $logocclass = 'col-md-4 col-lg-2'; $menulclass = 'col-md-4 col-lg-5';
        } else if($bigcloudcms_premium['logo_layout'] == 'logohalf') {
  ...
  <div class="container">
    ...
    <?php if (has_nav_menu('mobile_navigation')) : ?>
     ...
     <?php global $bigcloudcms_premium; if (!empty($bigcloudcms_premium['bigcloudcms_banner_upload']['url'])) {  ?> 
        <div class="container bigcloudcms_sitewide_banner"><div class="bigcloudcms_banner">
